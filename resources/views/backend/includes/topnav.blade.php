...
<div style="padding: -30px" class="page-header navbar navbar-fixed-top" >
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="/">
                <img src="https://noticepark.com/admin-assets/images/organization/organization-1617461318-21f4762b0da0e04965a240de94dd1b33.png" alt="logo" class="logo-default" style="width: 80px;
    margin-left: 37px;
    margin-top: -6px;
    padding: 10px;
">
