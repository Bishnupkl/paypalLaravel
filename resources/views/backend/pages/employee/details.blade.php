...
@section('main-content')
    <form action="{{route('service.update',$staff_details->id)}}" method="post"  enctype="multipart/form-data" class="portlet light">
            ...
            <div class="col-sm-12">
                <div class="portlet-title">
                    <div class="caption font-green">
                        ...
                        <span class="caption-subject bold"> Update Employee </span>
                    </div>
                </div>
            </div>
        </div>
