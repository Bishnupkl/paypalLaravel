...
@section('main-content')
    <div class="logo">
        <a href="http://localhost:8000">
            <img src="https://noticepark.com/admin-assets/images/organization/organization-1617461318-21f4762b0da0e04965a240de94dd1b33.png" alt="logo" alt="logo" width="" height="80px">
        </a>
    </div>
    <div class="content">
        <!-- BEGIN LOGIN FORM -->
